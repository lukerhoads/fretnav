    ...
    return (
        <div className={styles.position_container} style={{
            ...
            <div className={styles.position_container_top}>
                ...
                <div>
                { moveable &&  <input type="checkbox" checked={sync_to_note ? sync_to_note : false} onChange={() => onSyncChange(!sync_to_note)} /> }
            ...
            <div className={styles.position_input}>
                <input placeholder="Label" value={label} onChange={(e) => onLabelChange(e.target.value)} />
                <Select 
